...
/// scaling — the name would be cut short, so the clock and the language
/// switch move to a second row under it.
class HeaderBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final name = Text(
      // The office names itself: whatever the backend publishes is what the
      // header shows.
