...
|------|------|------|---------|
| `windows/flutter/ephemeral/flutter_windows.dll.pdb` | 264M | Flutter Windows debug simvollari | `flutter pub get` / build |
| `dist/` | 138M | Build/paketlash natijasi | Qayta build qilinadi |
| `build/` | 762M | Flutter build natijasi | `flutter build` |
| `.dart_tool/` | 310M | Dart/pub cache | `flutter pub get` |
